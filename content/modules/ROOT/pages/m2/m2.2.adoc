...
[.text-center]
image::m2/processing-flow-chat2kafka.jpg[width=90%]
...
image::m2/flow-m2k-todo.jpg[width=80%]
...
+
image::m2/mapping-matrix-kafka.png[width=80%]
+
{empty} +
...
The mapping rendering should be similar to:
+
image::m2/mapping-rocketchat-kafka.png[width=90%]
+
{empty} +
