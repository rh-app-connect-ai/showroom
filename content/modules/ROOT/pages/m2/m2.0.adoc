...
[id='lab2-matrix-kafka-rocketchat']
== Lab 2 - Kafka as the Backbone
...
[.text-center]
image::m2/data-flow.png[width=90%]
...
[.text-center]
image::m2/standard-data-model.png[width=90%]
